...
@Component({
  selector: 'app-mid-nifty',
  templateUrl: './mid-nifty.component.html',
  styleUrls: ['./mid-nifty.component.css']
})
export class MidNiftyComponent implements OnInit {
